      ...
      <Box>
        {allEvents.length > 0 ? (
                ...
                .map(({ title, start }, index) => {
                  ...
                  return (
                    <Button
                      ...
                      onClick={() => (
                        handleWorkoutModal(index), setSelectedSkill(0)
                ...
                .map(({ title, start }, index) => {
                  ...
                  return (
                    <Button
                      ...
                      sx={{ color: "white", flexShrink: 0 }}
                      onClick={() => (
                        handleWorkoutModal(index), setSelectedSkill(1)
                      )} // Ensure correct index is passed here
                    >
                      <Box
                        width={isMobile ? "150px" : "300px"}
          ...
          <Typography sx={{ fontWeight: "300" }}>
            Now that you have a workout plan, go to the myPlanner page to create
            your schedule.
          </Typography>
        )}
      </Box>
    ) : (
      <Typography sx={{ fontWeight: "300", padding: 1 }}>
        Get started by asking trainerGPT for a workout plan!
      </Typography>
    )}
